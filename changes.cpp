...
int main()
{
	...
	skiploom.type = "Grass/Flying";
	skiploom.poke_id = 188;
	strcpy(jumpluff.name, "Jumpluff");
	jumpluff.type = "Grass/Flying";
	...
	yanma.type = "Bug/Flying";
	yanma.poke_id = 193;
	strcpy(wooper.name, "Wooper");
	wooper.type = "Water/Ground";
	wooper.poke_id = 194;
