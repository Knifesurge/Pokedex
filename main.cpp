...
int main()
{
	...
	strcpy(granbull.name, "Granbull");
	strcpy(granbull.type, "Normal");
	granbull.poke_id = 210;
	strcpy(qwilfish.name, "Qwilfish");
	strcpy(qwilfish.type, "Water/Poison");
	qwilfish.poke_id = 211;
